...
<body >
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse" style=" padding-top: 15px; ">
        <ul class="nav navbar-nav" data-0="margin-top:20px;" data-300="margin-top:5px;">
          ...
          <li class="active"><a href="adminlogin.php" style="font-size: 17px;"><b>Admin Login</b></a></li>
        </ul>
      </div>
    </div>
  </div><br><br><br><br>
  ...
  <div id="article">
  	<div>
      <br>
  		<center><label id="a" style="color: black;">Admin Login</label><br><br></center>
      <center><img src="img/admin.png" width="280px" height="220px"></center>
